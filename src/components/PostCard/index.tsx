...
export default function PostCard(props: PostCardProps) {
  ...
  return (
    <>
      ...
      >
        <CardBody>
          <div className='relative aspect-square h-32 w-32 overflow-hidden rounded-medium'>
          ...
          <div className='flex flex-grow flex-col gap-1 px-4 py-2'>
            <h5>{data.title}</h5>
            <p className='line-clamp-2 flex-grow text-small text-default-500'>{data.summary}</p>
            <div className='flex w-full items-center justify-between gap-4 text-tiny text-default-400'>
              <Tooltip
                className='text-tiny'
